...
class NetworkModelBase(nn.Module):
    def __init__(self):
        ...
        self.encoder = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Flatten(),
            MLP([4096, 512], "encoder_mlp", non_linearity_last=True),  # (512,)
        )

        self.action_mlp = MLP([512 + 5, 64, self.action_num], "action_mlp")
        self.value_mlp = MLP([512 + 5, 64, self.value_num], "value_mlp")
